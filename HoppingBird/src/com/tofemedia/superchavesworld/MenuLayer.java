...
public class MenuLayer extends CCLayer {
	...
	public MenuLayer(boolean playMusic)
	{
		...
		CCMenuItemImage game_center = CCMenuItemImage.item("menu/leaderboard.png", "menu/leaderboard_clicked.png", this, "onLeaderBoard");
		game_center.setAnchorPoint(0.5f, 0);
		game_center.setPosition(G.width*0.5f, 140);
		
		// for more 
		CCMenuItemImage moreItem = CCMenuItemImage.item("menu/more.png", "menu/more1.png", this, "openMoreGames");
		moreItem.setAnchorPoint(0.5f, 0);
		moreItem.setPosition(G.width*0.4f, 140);
		
		CCMenuItemImage moreItem2 = CCMenuItemImage.item("menu/more2.png", "menu/more2.png", this, "superchaves");
	...
	public void openMoreGames(Object sender){
		MainActivity.app.openMoreGame();
	}
	
	public void superchaves(Object sender){
		MainActivity.app.superchaves2();
	}
	
	public void onLeaderBoard(Object sender){
		Intent intent=new Intent(MainActivity.app, LeaderBoardActivity.class);
